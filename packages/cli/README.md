...
Install SDK 1.1.0-alpha.1 in the author project. Executable plugins also need
...
Install this alpha with `pnpm add -D @lomi-dev/plugin-cli@0.1.0-alpha.2
@lomi-dev/plugin-sdk@1.1.0-alpha.1` (one command). Run the project diagnostic
