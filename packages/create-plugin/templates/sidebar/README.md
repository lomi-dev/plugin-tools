...
Template: `sidebar`. Uses host API 1 and the Lomi 0.4.0 source baseline.
...
Uruchom `pnpm install --ignore-scripts`, aby pobrać przypięte wersje SDK i CLI z npm.
Zapisz utworzony `pnpm-lock.yaml` przed włączeniem CI.
